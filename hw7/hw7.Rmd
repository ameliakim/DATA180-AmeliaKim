...
library(tidyverse)
library(tm)
news<-read.csv("~/Desktop/Data-180-AmeliaKim/Untitled/DATA180-AmeliaKim/hw7/news.csv",header=T)
```

Read also the positive and negative word dictionaries, both found on Github. This will later come in handy:

```{r}
posWords <- scan("~/Desktop/Data-180-AmeliaKim/Untitled/DATA180-AmeliaKim/hw7/positive-words.txt", character(0), sep = "\n")  # 2006 items
negWords <- scan("~/Desktop/Data-180-AmeliaKim/Untitled/DATA180-AmeliaKim/hw7/negative-words.txt", character(0), sep = "\n")  # 4783 items
head(posWords,15)
head(negWords,15)
```
