...
```{r}
ggplot(Cars93, aes(x = EngineSize, y = MPG.city)) + 
  geom_point(color = "blue", size = 2) + xlim(0,max(Cars93$EngineSize)+1) + ylim(0,max(Cars93$MPG.city)+1) + labs(title = "Scatterplot of Engine Size vs MPG City", subtitle = "from ggplot2", x = "Engine Size", y = "MPG City", caption = "Task 1")
```
...
```{r}
ggplot(Cars93, aes(x = EngineSize, y = MPG.city, color = Type)) +
  geom_point(size = 2) + xlim(0,max(Cars93$EngineSize)+1) + ylim(0,max(Cars93$MPG.city)+1) + labs(title = "Scatterplot of Engine Size vs MPG City", subtitle = "from ggplot2", x = "Engine Size", y = "MPG City", caption = "Task 2")
```
...
```{r}
ggplot(Cars93, aes(x = EngineSize, y = MPG.city, color = Type)) +
  geom_point(size = 2) + geom_smooth(method = "lm", se = FALSE, linetype = "dashed", color = "red") + xlim(0, max(Cars93$EngineSize) + 1) + ylim(0, max(Cars93$MPG.city) + 5) + labs(title = "Scatterplot of Engine Size vs MPG City", subtitle = "from ggplot", x = "Engine Size", y = "MPG City",caption = "Task 3")
```
...
ggplot(data = Cars93, aes(x = AirBags, fill = AirBags)) +
  geom_bar() + labs(title = "Count of Cars by AirBags", subtitle = "from ggplot", x = "Airbags", y = "Count",caption = "Task 4")
```
...
ggplot(data = Cars93, aes(x = Origin, fill = AirBags)) +
  geom_bar(position = 'dodge') + labs(title = "Count of Cars by AirBags and Origin", subtitle = "from ggplot", x = "Origin", y = "Count",caption = "Task 5")
```
...
ggplot(data = au_states) +
  geom_sf() + labs(title = "Map of Australia")
```
...
```{r}
ggplot(data = au_states) +
  geom_sf(aes(fill = NAME)) + labs(title = "Map of Australia")
```
## Task 3
...
```{r}
ggplot() + geom_sf(data = au_states, aes(fill = NAME)) + geom_point(data = au_capitals, aes(x = lon, y = lat), col = "red", size = 2) + labs(title = "Map of Australia with State Colors and Capitals")
```
...
```{r}
ggplot() + geom_sf(data = au_states, aes(fill = NAME)) + geom_point(data = au_capitals, aes(x = lon, y = lat), col = "red", size = 2) + coord_sf(crs = st_crs(3112)) + labs(title = "Map of Australia with State Colors and Capitals")
```
...
```{r}
au_capitals_sf <- st_as_sf(au_capitals, coords = c("lon", "lat"), crs = st_crs(3112))

mapview(au_states) +
  mapview(au_capitals_sf, col.regions = 'red', legend = FALSE)
```
