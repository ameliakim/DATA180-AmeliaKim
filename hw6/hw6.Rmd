...
#The elbow plot suggests 8 clusters. The dendrogram in Question 2 is more challenging to interpret, so the use of K clustering helped analyze the data and easily identify the number of clusters.
```
