...
#NTSC runs at a faster FPS than PAL. This affects the performance of records set because the averages of NTSC are lower, meaning they perform faster than PAL.
```
